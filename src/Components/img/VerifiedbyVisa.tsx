...
function VerifiedbyVisa(){
	...
	const st0 = { fill: isHovered ? "#11559C" : "#fff" };
	const st1 = { fill: isHovered ? "#F2A724" : "#fff" };
	...
	return(
		...
		>
			<svg 
				...
				width={80}
				viewBox="0 120 800 500" 
				xmlSpace="preserve"

			>
			<g>
				<path style={st0} d="M330.4,410.6L294,508.9l-3.9-20c-9.1-24.5-28.8-50.2-51.7-60.7l33.4,126.3l39.5,0l58.7-144.1H330.4
					L330.4,410.6z"/>
				<polygon style={st0} points="361.7,554.8 385,410.4 422.3,410.4 399,554.8 361.7,554.8 	"/>
				<path style={st0} d="M534.2,414c-7.4-2.9-19-6.1-33.4-6.1c-36.9,0-62.8,19.6-63,47.6c-0.2,20.8,18.5,32.3,32.6,39.2
				...
				<path style={st0} d="M629.8,410.6H601c-8.9,0-15.6,2.5-19.6,12l-55.3,132.3h39.1c0,0,6.4-17.8,7.9-21.7c4.3,0,42.3,0.1,47.7,0.1
				...
				<path style={st1} d="M260.1,410.5H200l-0.4,2.5c46.7,12,77.6,41.3,90.4,76L277,422.6C274.8,413.5,268.2,410.8,260.1,410.5
					L260.1,410.5z"/>
				<polygon style={st0} points="87.2,375.6 63.5,375.6 36,252 62.3,247.6 81.1,344.3 128.9,248.9 154.1,248.9 87.2,375.6 	"/>
				<path style={st0} d="M210.9,335.2h-56.7c-1.6,17.2,6.4,24.7,20,24.7c11.3,0,21.3-4.2,32-11l-0.1,17.2c-10.5,6.6-22.7,10.8-37,10.8
				...
				<path style={st0} d="M247.8,324.4L240,375h-21.9l13.6-88.3h18.7l0,17.7c7.4-10.2,17.5-18.8,31.4-19.6l0.1,21.8
					C267.9,307.6,255.5,314.9,247.8,324.4L247.8,324.4z"/>
				<path style={st0} d="M281.5,375l13.6-88.3H317L303.5,375H281.5L281.5,375z M308.5,271.9c-7.3,0-12.4-5.1-11.2-12.4
					c1.2-7.5,7.8-12.8,15.1-12.8c7.1,0,12.2,5.3,11,12.8C322.3,266.8,315.7,271.9,308.5,271.9L308.5,271.9z"/>
				<path style={st0} d="M377.8,262.6c-7.5,0-12,3.3-13.2,11.2l-2,13h16.8l0,17.9h-19.6L349,375h-21.8l10.8-70.4h-12.8l2.8-17.9h12.8
					l2.3-15.2c3-19.6,16.6-26.9,34.7-26.9c3.8,0,6.7,0.4,8.9,0.7l0.2,17.9C384.7,263,381.5,262.6,377.8,262.6L377.8,262.6z"/>
				<path style={st0} d="M378,375l13.6-88.3h21.9L400,375H378L378,375z M405.1,271.9c-7.3,0-12.4-5.1-11.3-12.4
					c1.2-7.5,7.8-12.8,15.1-12.8c7.1,0,12.2,5.3,11,12.8C418.8,266.8,412.2,271.9,405.1,271.9L405.1,271.9z"/>
				<path style={st0} d="M498.7,335.2H442c-1.5,17.2,6.4,24.7,20,24.7c11.3,0,21.3-4.2,32-11l-0.1,17.2c-10.5,6.6-22.7,10.8-37,10.8
				...
				<path style={st0} d="M563.6,375l0.1-12.3c-7.4,7.5-17,14.1-29.2,14.1c-18.5,0-31.2-13.7-26.6-43.5c5.1-32.9,25.4-47.5,45.9-47.5
				...
				<path style={st0} d="M649.7,375.9c-10.4,0-18.9-1.7-26.7-4.4l14.4-93.8l17-2.6l-6.2,40.6c5-4.4,11.9-8.9,20.3-8.9
				...
				<path style={st0} d="M727.8,378.7c-8.5,16.5-16.9,21.6-29.8,21.6c-2.9,0-4.5-0.3-6-0.7l-0.1-13.7c2.1,0.6,4.4,1,7.6,1
